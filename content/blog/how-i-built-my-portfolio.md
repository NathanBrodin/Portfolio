...
I wanted to talk a bit about my [portfolio](https://brodin.dev), how I built it, and why I made some of these architectural and design decisions.
...
## Stealing, hmmm I mean getting inspired by Chanhdai and Zed

Now I'm not going to lie and say I designed and coded everything myself. I took large parts of the code and design layout from the open-source portfolio by [Chanhdai](https://chanhdai.com) and design inspiration from [zed.dev](https://zed.dev), which I had previously attempted in unfinished side projects (https://trends.brodin.dev and https://ui.brodin.dev if they're still available).
